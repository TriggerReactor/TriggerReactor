...
public class ReflectionUtilTest {
    ...
    public void constructNew1() throws NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        assertEquals(new OtherValue(1, 1), ReflectionUtil.constructNew(OtherValue.class, 1, 1.0));
    ...
    public void invocationHandlerTest() throws Throwable {
        ...
        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", lambdaFunction);

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", 1, lambdaFunction);

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", 1, lambdaFunction, "a");

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", "a", lambdaFunction, 1);

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", "a", lambdaFunction, "a");

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", lambdaFunction, "a");

        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "noArg", lambdaFunction, "1");
    ...
    public void invocationHandlerTest2() throws Throwable {
        ...
        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "oneArg", lambdaFunction);
    ...
    public void invocationHandlerTest3() throws Throwable {
        ...
        ReflectionUtil.invokeMethod(SomeStaticClass.class, (Object) null, "twoArg", lambdaFunction);
    ...
    public void invokeMethod1() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        // test overloads
        assertEquals(1, ReflectionUtil.invokeMethod(ReflectionUtilTest.class, (Object) null, "method1", 7, 7, 7));

        assertEquals(2, ReflectionUtil.invokeMethod(ReflectionUtilTest.class, (Object) null, "method1", 7.0, 7.0, 7));

        assertEquals(2, ReflectionUtil.invokeMethod(ReflectionUtilTest.class, (Object) null, "method1", 7, 7.0, 7));
...
//                1, 2));
        ...
        assertEquals(1, ReflectionUtil.invokeMethod(ReflectionUtilTest.class, (Object) null, "method1", 1, 2, 3));

        // the concrete argument method should have priority in this case
        assertEquals(2, ReflectionUtil.invokeMethod(ReflectionUtilTest.class, (Object) null, "method1", 5.0, 6.0, 7.0));
