...
public class MockGameManagementModule extends AbstractModule {
    private final IGameManagement gameManagement;

    public MockGameManagementModule(IGameManagement gameManagement) {
        this.gameManagement = gameManagement;
    }

    @Provides
    IGameManagement provideGameManagement() {
