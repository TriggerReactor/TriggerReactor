...
package io.github.wysohn.gsoncopy.internal;

import io.github.wysohn.gsoncopy.InstanceCreator;
import io.github.wysohn.gsoncopy.JsonIOException;
            ...
            public T construct() {
                try {
                    ...
                    throw new RuntimeException(
                            ("Unable to invoke no-args constructor for " + type + ". Registering an InstanceCreator with Gson for this type may fix this problem."),
                            e);
                }
            }
        };
