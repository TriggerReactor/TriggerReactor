...
public final class NamedTriggerManager extends AbstractTriggerManager<NamedTrigger> {
    ...
    public NamedTriggerManager(TriggerReactorCore plugin, ITriggerLoader<NamedTrigger> loader) {
        super(plugin, new File(plugin.getDataFolder(), "NamedTriggers"), loader);
    }

    public NamedTriggerManager(TriggerReactorCore plugin){
        this(plugin, new NamedTriggerLoader());
    }
