...
public class TriggerManagerModule extends AbstractModule {
    ...
    protected void configure() {
        install(new ClickTriggerModule());
        install(new WalkTriggerModule());
        install(new CommandTriggerModule());

        install(new AreaTriggerModule());
        install(new NamedTriggerModule());
        install(new CustomTriggerModule());
