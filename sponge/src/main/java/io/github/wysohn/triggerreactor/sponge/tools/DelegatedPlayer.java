...
public class DelegatedPlayer implements Player {
    ...
    public MutableBoundedValue<Double> exhaustion() {
        return Sponge.getRegistry()
                .getValueFactory()
                .createBoundedValueBuilder(Keys.EXHAUSTION)
                .actualValue(-1.0)
                .build();
    }
    ...
    public MutableBoundedValue<Integer> foodLevel() {
        return Sponge.getRegistry()
                .getValueFactory()
                .createBoundedValueBuilder(Keys.FOOD_LEVEL)
                .actualValue(-1)
                .build();
    }
    ...
    public MutableBoundedValue<Double> maxHealth() {
        return Sponge.getRegistry()
                .getValueFactory()
                .createBoundedValueBuilder(Keys.MAX_HEALTH)
                .actualValue(-1.0)
                .build();
    }
    ...
    public MutableBoundedValue<Double> saturation() {
        return Sponge.getRegistry()
                .getValueFactory()
                .createBoundedValueBuilder(Keys.SATURATION)
                .actualValue(-1.0)
                .build();
    }
